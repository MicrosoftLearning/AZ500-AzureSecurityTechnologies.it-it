...
#### <a name="task-1-use-azure-cli-to-create-a-user-account-for-dylan-williams"></a>Attività 1: Usare l'interfaccia della riga di comando di Azure per creare un account utente per Dylan Williams.
